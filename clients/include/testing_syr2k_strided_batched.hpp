...
void testing_syr2k_strided_batched_bad_arg(const Arguments& arg)
{
    ...
    EXPECT_ROCBLAS_STATUS(rocblas_syr2k_strided_batched<T>(nullptr,
                                                           uplo,
                                                           transA,
                                                           N,
                                                           K,
    ...
    EXPECT_ROCBLAS_STATUS(rocblas_syr2k_strided_batched<T>(handle,
                                                           rocblas_fill_full,
                                                           transA,
                                                           N,
                                                           K,
...
void testing_syr2k_strided_batched(const Arguments& arg)
{
    ...
    if(arg.unit_check || arg.norm_check)
    {
        ...
        CHECK_ROCBLAS_ERROR(rocblas_syr2k_strided_batched<T>(handle,
                                                             uplo,
                                                             transA,
                                                             N,
                                                             K,
        ...
        {
            auto err1 = std::abs(
                norm_check_general<T>('F', N, N, batch_count, ldc, strideC, hC_gold, hC_1));
            auto err2 = std::abs(
                norm_check_general<T>('F', N, N, batch_count, ldc, strideC, hC_gold, hC_2));
    ...
    if(arg.timing)
    {
        ...
        {
            rocblas_syr2k_strided_batched<T>(handle,
                                             uplo,
                                             transA,
                                             N,
                                             K,
