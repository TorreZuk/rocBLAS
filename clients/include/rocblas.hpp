...
template <>
static constexpr auto rocblas_asum<float> = rocblas_sasum;

template <>
static constexpr auto rocblas_asum<double> = rocblas_dasum;

template <>
static constexpr auto rocblas_asum<rocblas_float_complex> = rocblas_scasum;

template <>
static constexpr auto rocblas_asum<rocblas_double_complex> = rocblas_dzasum;
...
template <>
static constexpr auto rocblas_asum_batched<float> = rocblas_sasum_batched;

template <>
static constexpr auto rocblas_asum_batched<double> = rocblas_dasum_batched;

template <>
static constexpr auto rocblas_asum_batched<rocblas_float_complex> = rocblas_scasum_batched;

template <>
static constexpr auto rocblas_asum_batched<rocblas_double_complex> = rocblas_dzasum_batched;
...
template <>
static constexpr auto rocblas_asum_strided_batched<float> = rocblas_sasum_strided_batched;

template <>
static constexpr auto rocblas_asum_strided_batched<double> = rocblas_dasum_strided_batched;
...
template <>
static constexpr auto rocblas_nrm2<float> = rocblas_snrm2;

template <>
static constexpr auto rocblas_nrm2<double> = rocblas_dnrm2;

template <>
static constexpr auto rocblas_nrm2<rocblas_float_complex> = rocblas_scnrm2;

template <>
static constexpr auto rocblas_nrm2<rocblas_double_complex> = rocblas_dznrm2;
...
template <>
static constexpr auto rocblas_nrm2_batched<float> = rocblas_snrm2_batched;

template <>
static constexpr auto rocblas_nrm2_batched<double> = rocblas_dnrm2_batched;

template <>
static constexpr auto rocblas_nrm2_batched<rocblas_float_complex> = rocblas_scnrm2_batched;

template <>
static constexpr auto rocblas_nrm2_batched<rocblas_double_complex> = rocblas_dznrm2_batched;
...
template <>
static constexpr auto rocblas_nrm2_strided_batched<float> = rocblas_snrm2_strided_batched;

template <>
static constexpr auto rocblas_nrm2_strided_batched<double> = rocblas_dnrm2_strided_batched;
...
// syr2
template <typename T>
rocblas_status (*rocblas_syr2)(rocblas_handle handle,
                               rocblas_fill   uplo,
                               rocblas_int    n,
                               const T*       alpha,
                               const T*       x,
...
template <>
static constexpr auto rocblas_syr2<float> = rocblas_ssyr2;

template <>
static constexpr auto rocblas_syr2<double> = rocblas_dsyr2;

template <>
static constexpr auto rocblas_syr2<rocblas_float_complex> = rocblas_csyr2;

template <>
static constexpr auto rocblas_syr2<rocblas_double_complex> = rocblas_zsyr2;

// syr2 batched
template <typename T>
rocblas_status (*rocblas_syr2_batched)(rocblas_handle handle,
                                       rocblas_fill   uplo,
                                       rocblas_int    n,
                                       const T*       alpha,
                                       const T* const x[],
...
template <>
static constexpr auto rocblas_syr2_batched<float> = rocblas_ssyr2_batched;

template <>
static constexpr auto rocblas_syr2_batched<double> = rocblas_dsyr2_batched;

template <>
static constexpr auto rocblas_syr2_batched<rocblas_float_complex> = rocblas_csyr2_batched;

template <>
static constexpr auto rocblas_syr2_batched<rocblas_double_complex> = rocblas_zsyr2_batched;

// syr2 strided batched
template <typename T>
rocblas_status (*rocblas_syr2_strided_batched)(rocblas_handle handle,
                                               rocblas_fill   uplo,
                                               rocblas_int    n,
                                               const T*       alpha,
                                               const T*       x,
...
template <>
static constexpr auto rocblas_syr2_strided_batched<float> = rocblas_ssyr2_strided_batched;

template <>
static constexpr auto rocblas_syr2_strided_batched<double> = rocblas_dsyr2_strided_batched;
...
// her
template <typename T>
rocblas_status (*rocblas_her)(rocblas_handle   handle,
                              rocblas_fill     uplo,
                              rocblas_int      n,
                              ...
                              rocblas_int      lda);
template <>
static constexpr auto rocblas_her<rocblas_float_complex> = rocblas_cher;

template <>
static constexpr auto rocblas_her<rocblas_double_complex> = rocblas_zher;

// her_batched
template <typename T>
rocblas_status (*rocblas_her_batched)(rocblas_handle   handle,
                                      rocblas_fill     uplo,
                                      rocblas_int      n,
                                      const real_t<T>* alpha,
                                      const T* const   x[],
                                      ...
                                      rocblas_int      batch_count);
template <>
static constexpr auto rocblas_her_batched<rocblas_float_complex> = rocblas_cher_batched;

template <>
static constexpr auto rocblas_her_batched<rocblas_double_complex> = rocblas_zher_batched;

// her_strided_batched
template <typename T>
rocblas_status (*rocblas_her_strided_batched)(rocblas_handle   handle,
                                              rocblas_fill     uplo,
                                              rocblas_int      n,
                                              const real_t<T>* alpha,
                                              const T*         x,
...
rocblas_status (*rocblas_her2)(rocblas_handle handle,
                               ...
                               rocblas_int    lda);
template <>
static constexpr auto rocblas_her2<rocblas_float_complex> = rocblas_cher2;

template <>
static constexpr auto rocblas_her2<rocblas_double_complex> = rocblas_zher2;

// her2_batched
template <typename T>
rocblas_status (*rocblas_her2_batched)(rocblas_handle handle,
                                       rocblas_fill   uplo,
                                       rocblas_int    n,
                                       const T*       alpha,
                                       const T* const x[],
...
template <>
static constexpr auto rocblas_her2_batched<rocblas_float_complex> = rocblas_cher2_batched;

template <>
static constexpr auto rocblas_her2_batched<rocblas_double_complex> = rocblas_zher2_batched;

// her2_strided_batched
template <typename T>
rocblas_status (*rocblas_her2_strided_batched)(rocblas_handle handle,
                                               rocblas_fill   uplo,
                                               rocblas_int    n,
                                               const T*       alpha,
                                               const T*       x,
...
rocblas_status (*rocblas_hpr)(rocblas_handle   handle,
                              ...
                              T*               AP);
template <>
static constexpr auto rocblas_hpr<rocblas_float_complex> = rocblas_chpr;

template <>
static constexpr auto rocblas_hpr<rocblas_double_complex> = rocblas_zhpr;
...
template <>
static constexpr auto rocblas_hpr_batched<rocblas_float_complex> = rocblas_chpr_batched;

template <>
static constexpr auto rocblas_hpr_batched<rocblas_double_complex> = rocblas_zhpr_batched;
...
// hpr2
template <typename T>
rocblas_status (*rocblas_hpr2)(rocblas_handle handle,
                               rocblas_fill   uplo,
                               rocblas_int    n,
                               const T*       alpha,
                               const T*       x,
                               ...
                               T*             AP);
template <>
static constexpr auto rocblas_hpr2<rocblas_float_complex> = rocblas_chpr2;

template <>
static constexpr auto rocblas_hpr2<rocblas_double_complex> = rocblas_zhpr2;

// hpr2_batched
template <typename T>
rocblas_status (*rocblas_hpr2_batched)(rocblas_handle handle,
                                       rocblas_fill   uplo,
                                       rocblas_int    n,
                                       const T*       alpha,
                                       const T* const x[],
                                       ...
                                       rocblas_int    batch_count);
template <>
static constexpr auto rocblas_hpr2_batched<rocblas_float_complex> = rocblas_chpr2_batched;

template <>
static constexpr auto rocblas_hpr2_batched<rocblas_double_complex> = rocblas_zhpr2_batched;

// hpr2_strided_batched
template <typename T>
rocblas_status (*rocblas_hpr2_strided_batched)(rocblas_handle handle,
                                               rocblas_fill   uplo,
                                               rocblas_int    n,
                                               const T*       alpha,
                                               const T*       x,
...
// tpsv_batched
template <typename T>
rocblas_status (*rocblas_tpsv_batched)(rocblas_handle    handle,
                                       rocblas_fill      uplo,
                                       rocblas_operation transA,
                                       rocblas_diagonal  diag,
                                       rocblas_int       n,
...
template <>
static constexpr auto rocblas_tpsv_batched<float> = rocblas_stpsv_batched;

template <>
static constexpr auto rocblas_tpsv_batched<double> = rocblas_dtpsv_batched;

template <>
static constexpr auto rocblas_tpsv_batched<rocblas_float_complex> = rocblas_ctpsv_batched;

template <>
static constexpr auto rocblas_tpsv_batched<rocblas_double_complex> = rocblas_ztpsv_batched;

// tpsv_strided_batched
template <typename T>
rocblas_status (*rocblas_tpsv_strided_batched)(rocblas_handle    handle,
                                               rocblas_fill      uplo,
                                               rocblas_operation transA,
                                               rocblas_diagonal  diag,
                                               rocblas_int       n,
...
template <>
static constexpr auto rocblas_tpsv_strided_batched<float> = rocblas_stpsv_strided_batched;

template <>
static constexpr auto rocblas_tpsv_strided_batched<double> = rocblas_dtpsv_strided_batched;
...
// hemm
template <typename T>
rocblas_status (*rocblas_hemm)(rocblas_handle handle,
                               rocblas_side   side,
                               rocblas_fill   uplo,
                               rocblas_int    m,
                               rocblas_int    n,
...
template <>
static constexpr auto rocblas_hemm<rocblas_float_complex> = rocblas_chemm;

template <>
static constexpr auto rocblas_hemm<rocblas_double_complex> = rocblas_zhemm;

// hemm batched
template <typename T>
rocblas_status (*rocblas_hemm_batched)(rocblas_handle handle,
                                       rocblas_side   side,
                                       rocblas_fill   uplo,
                                       rocblas_int    m,
                                       rocblas_int    n,
...
template <>
static constexpr auto rocblas_hemm_batched<rocblas_float_complex> = rocblas_chemm_batched;

template <>
static constexpr auto rocblas_hemm_batched<rocblas_double_complex> = rocblas_zhemm_batched;

// hemm strided batched
template <typename T>
rocblas_status (*rocblas_hemm_strided_batched)(rocblas_handle handle,
                                               rocblas_side   side,
                                               rocblas_fill   uplo,
                                               rocblas_int    m,
                                               rocblas_int    n,
...
template <>
static constexpr auto rocblas_herk<rocblas_float_complex, float> = rocblas_cherk;
...
template <>
static constexpr auto rocblas_herk_batched<rocblas_float_complex, float> = rocblas_cherk_batched;
...
// her2k
template <typename T, typename U = real_t<T>>
rocblas_status (*rocblas_her2k)(rocblas_handle    handle,
                                rocblas_fill      uplo,
                                rocblas_operation transA,
                                rocblas_int       n,
                                rocblas_int       k,
...
template <>
static constexpr auto rocblas_her2k<rocblas_float_complex, float> = rocblas_cher2k;

template <>
static constexpr auto rocblas_her2k<rocblas_double_complex, double> = rocblas_zher2k;

// her2k batched
template <typename T, typename U = real_t<T>>
rocblas_status (*rocblas_her2k_batched)(rocblas_handle    handle,
                                        rocblas_fill      uplo,
                                        rocblas_operation transA,
                                        rocblas_int       n,
                                        rocblas_int       k,
...
template <>
static constexpr auto rocblas_her2k_batched<rocblas_float_complex, float> = rocblas_cher2k_batched;
...
template <typename T, typename U = real_t<T>>
rocblas_status (*rocblas_her2k_strided_batched)(rocblas_handle    handle,
                                                rocblas_fill      uplo,
                                                rocblas_operation transA,
                                                rocblas_int       n,
                                                rocblas_int       k,
...
// herkx
template <typename T, typename U = real_t<T>>
rocblas_status (*rocblas_herkx)(rocblas_handle    handle,
                                rocblas_fill      uplo,
                                rocblas_operation transA,
                                rocblas_int       n,
                                rocblas_int       k,
...
template <>
static constexpr auto rocblas_herkx<rocblas_float_complex, float> = rocblas_cherkx;

template <>
static constexpr auto rocblas_herkx<rocblas_double_complex, double> = rocblas_zherkx;

// herkx batched
template <typename T, typename U = real_t<T>>
rocblas_status (*rocblas_herkx_batched)(rocblas_handle    handle,
                                        rocblas_fill      uplo,
                                        rocblas_operation transA,
                                        rocblas_int       n,
                                        rocblas_int       k,
...
template <>
static constexpr auto rocblas_herkx_batched<rocblas_float_complex, float> = rocblas_cherkx_batched;
...
template <typename T, typename U = real_t<T>>
rocblas_status (*rocblas_herkx_strided_batched)(rocblas_handle    handle,
                                                rocblas_fill      uplo,
                                                rocblas_operation transA,
                                                rocblas_int       n,
                                                rocblas_int       k,
...
// symm
template <typename T>
rocblas_status (*rocblas_symm)(rocblas_handle handle,
                               rocblas_side   side,
                               rocblas_fill   uplo,
                               rocblas_int    m,
                               rocblas_int    n,
...
template <>
static constexpr auto rocblas_symm<float> = rocblas_ssymm;

template <>
static constexpr auto rocblas_symm<double> = rocblas_dsymm;

template <>
static constexpr auto rocblas_symm<rocblas_float_complex> = rocblas_csymm;

template <>
static constexpr auto rocblas_symm<rocblas_double_complex> = rocblas_zsymm;

// symm batched
template <typename T>
rocblas_status (*rocblas_symm_batched)(rocblas_handle handle,
                                       rocblas_side   side,
                                       rocblas_fill   uplo,
                                       rocblas_int    m,
                                       rocblas_int    n,
...
template <>
static constexpr auto rocblas_symm_batched<float> = rocblas_ssymm_batched;

template <>
static constexpr auto rocblas_symm_batched<double> = rocblas_dsymm_batched;

template <>
static constexpr auto rocblas_symm_batched<rocblas_float_complex> = rocblas_csymm_batched;

template <>
static constexpr auto rocblas_symm_batched<rocblas_double_complex> = rocblas_zsymm_batched;

// symm strided batched
template <typename T>
rocblas_status (*rocblas_symm_strided_batched)(rocblas_handle handle,
                                               rocblas_side   side,
                                               rocblas_fill   uplo,
                                               rocblas_int    m,
                                               rocblas_int    n,
...
template <>
static constexpr auto rocblas_symm_strided_batched<float> = rocblas_ssymm_strided_batched;

template <>
static constexpr auto rocblas_symm_strided_batched<double> = rocblas_dsymm_strided_batched;
...
template <>
static constexpr auto rocblas_syrk<float> = rocblas_ssyrk;

template <>
static constexpr auto rocblas_syrk<double> = rocblas_dsyrk;

template <>
static constexpr auto rocblas_syrk<rocblas_float_complex> = rocblas_csyrk;

template <>
static constexpr auto rocblas_syrk<rocblas_double_complex> = rocblas_zsyrk;

// syrk batched
template <typename T>
rocblas_status (*rocblas_syrk_batched)(rocblas_handle    handle,
                                       rocblas_fill      uplo,
                                       rocblas_operation transA,
                                       rocblas_int       n,
                                       rocblas_int       k,
...
template <>
static constexpr auto rocblas_syrk_batched<float> = rocblas_ssyrk_batched;

template <>
static constexpr auto rocblas_syrk_batched<double> = rocblas_dsyrk_batched;

template <>
static constexpr auto rocblas_syrk_batched<rocblas_float_complex> = rocblas_csyrk_batched;

template <>
static constexpr auto rocblas_syrk_batched<rocblas_double_complex> = rocblas_zsyrk_batched;

// syrk strided batched
template <typename T>
rocblas_status (*rocblas_syrk_strided_batched)(rocblas_handle    handle,
                                               rocblas_fill      uplo,
                                               rocblas_operation transA,
                                               rocblas_int       n,
                                               rocblas_int       k,
...
template <>
static constexpr auto rocblas_syrk_strided_batched<float> = rocblas_ssyrk_strided_batched;

template <>
static constexpr auto rocblas_syrk_strided_batched<double> = rocblas_dsyrk_strided_batched;
...
// syr2k
template <typename T>
rocblas_status (*rocblas_syr2k)(rocblas_handle    handle,
                                rocblas_fill      uplo,
                                rocblas_operation transA,
                                rocblas_int       n,
                                rocblas_int       k,
...
template <>
static constexpr auto rocblas_syr2k<float> = rocblas_ssyr2k;

template <>
static constexpr auto rocblas_syr2k<double> = rocblas_dsyr2k;

template <>
static constexpr auto rocblas_syr2k<rocblas_float_complex> = rocblas_csyr2k;

template <>
static constexpr auto rocblas_syr2k<rocblas_double_complex> = rocblas_zsyr2k;

// syr2k batched
template <typename T>
rocblas_status (*rocblas_syr2k_batched)(rocblas_handle    handle,
                                        rocblas_fill      uplo,
                                        rocblas_operation transA,
                                        rocblas_int       n,
                                        rocblas_int       k,
...
template <>
static constexpr auto rocblas_syr2k_batched<float> = rocblas_ssyr2k_batched;

template <>
static constexpr auto rocblas_syr2k_batched<double> = rocblas_dsyr2k_batched;

template <>
static constexpr auto rocblas_syr2k_batched<rocblas_float_complex> = rocblas_csyr2k_batched;

template <>
static constexpr auto rocblas_syr2k_batched<rocblas_double_complex> = rocblas_zsyr2k_batched;

// syr2k strided batched
template <typename T>
rocblas_status (*rocblas_syr2k_strided_batched)(rocblas_handle    handle,
                                                rocblas_fill      uplo,
                                                rocblas_operation transA,
                                                rocblas_int       n,
                                                rocblas_int       k,
...
template <>
static constexpr auto rocblas_syr2k_strided_batched<float> = rocblas_ssyr2k_strided_batched;

template <>
static constexpr auto rocblas_syr2k_strided_batched<double> = rocblas_dsyr2k_strided_batched;
...
// syrkx
template <typename T>
rocblas_status (*rocblas_syrkx)(rocblas_handle    handle,
                                rocblas_fill      uplo,
                                rocblas_operation transA,
                                rocblas_int       n,
                                rocblas_int       k,
...
template <>
static constexpr auto rocblas_syrkx<float> = rocblas_ssyrkx;

template <>
static constexpr auto rocblas_syrkx<double> = rocblas_dsyrkx;

template <>
static constexpr auto rocblas_syrkx<rocblas_float_complex> = rocblas_csyrkx;

template <>
static constexpr auto rocblas_syrkx<rocblas_double_complex> = rocblas_zsyrkx;

// syrkx batched
template <typename T>
rocblas_status (*rocblas_syrkx_batched)(rocblas_handle    handle,
                                        rocblas_fill      uplo,
                                        rocblas_operation transA,
                                        rocblas_int       n,
                                        rocblas_int       k,
...
template <>
static constexpr auto rocblas_syrkx_batched<float> = rocblas_ssyrkx_batched;

template <>
static constexpr auto rocblas_syrkx_batched<double> = rocblas_dsyrkx_batched;

template <>
static constexpr auto rocblas_syrkx_batched<rocblas_float_complex> = rocblas_csyrkx_batched;

template <>
static constexpr auto rocblas_syrkx_batched<rocblas_double_complex> = rocblas_zsyrkx_batched;

// syrkx strided batched
template <typename T>
rocblas_status (*rocblas_syrkx_strided_batched)(rocblas_handle    handle,
                                                rocblas_fill      uplo,
                                                rocblas_operation transA,
                                                rocblas_int       n,
                                                rocblas_int       k,
...
template <>
static constexpr auto rocblas_syrkx_strided_batched<float> = rocblas_ssyrkx_strided_batched;

template <>
static constexpr auto rocblas_syrkx_strided_batched<double> = rocblas_dsyrkx_strided_batched;
...
// trmm_batched
template <typename T>
rocblas_status (*rocblas_trmm_batched)(rocblas_handle    handle,
                                       rocblas_side      side,
                                       rocblas_fill      uplo,
                                       rocblas_operation transa,
                                       rocblas_diagonal  diag,
...
template <>
static constexpr auto rocblas_trmm_batched<float> = rocblas_strmm_batched;

template <>
static constexpr auto rocblas_trmm_batched<double> = rocblas_dtrmm_batched;

template <>
static constexpr auto rocblas_trmm_batched<rocblas_float_complex> = rocblas_ctrmm_batched;

template <>
static constexpr auto rocblas_trmm_batched<rocblas_double_complex> = rocblas_ztrmm_batched;

// trmm_strided_batched
template <typename T>
rocblas_status (*rocblas_trmm_strided_batched)(rocblas_handle    handle,
                                               rocblas_side      side,
                                               rocblas_fill      uplo,
                                               rocblas_operation transa,
                                               rocblas_diagonal  diag,
...
template <>
static constexpr auto rocblas_trmm_strided_batched<float> = rocblas_strmm_strided_batched;

template <>
static constexpr auto rocblas_trmm_strided_batched<double> = rocblas_dtrmm_strided_batched;
