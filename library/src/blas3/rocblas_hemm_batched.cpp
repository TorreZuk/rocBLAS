...
namespace
{
    ...
    template <>
    constexpr char rocblas_hemm_name<rocblas_float_complex>[] = "rocblas_chemm_batched";
    template <>
    constexpr char rocblas_hemm_name<rocblas_double_complex>[] = "rocblas_zhemm_batched";
              ...
              | rocblas_layer_mode_log_profile))
        {
            ...
            if(handle->pointer_mode == rocblas_pointer_mode_host)
            {
                ...
                if(layer_mode & rocblas_layer_mode_log_bench)
                    log_bench(handle,
                              "./rocblas-bench -f hemm_batched -r",
...
IMPL(rocblas_chemm_batched, rocblas_float_complex);
IMPL(rocblas_zhemm_batched, rocblas_double_complex);
